...
namespace PinePie.PieTabs
{
    ...
    public static class NavigatorLoader
    {
        ...
        static void RunOnceOnLoad()
        {
            ...
            if (!Directory.Exists("Assets/assetStore/Upgrades/PinePie/PieTabs"))
                return;
    ...
    public static partial class Navigator
    {
        ...
        public static void Setup()
        {
            ...
            UI.mainUI.styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/assetStore/Upgrades/PinePie/PieTabs/Core/UI/PieDeskStyling.uss"));
        ...
        public static void SetupDragNDropForShortcutArea(VisualElement area, ShortcutButtonBundle navButtonsList)
        {
            ...
            area.RegisterCallback<DragPerformEvent>(evt =>
            {
                ...
                foreach (var obj in DragAndDrop.objectReferences)
                {
                    ...
                    var foundButton = navButtonsList.buttons.FirstOrDefault(b => b.buttonProp.path == path);
                    ShortcutButton buttonAtSamePath = foundButton?.buttonProp;

                    var button = new ShortcutButton(obj.name, path);
                    if (buttonAtSamePath != null) button = new ShortcutButton(obj.name, path, buttonAtSamePath.isMinimal, buttonAtSamePath.color);
